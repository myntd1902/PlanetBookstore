...
namespace PlanetBook.DataAccess.Repository
{
    public class SP_Call : ISP_Call
    {
        ...
        public void Execute(string procedureName, DynamicParameters dynamicParameters = null)
        {
            ...
            {
                conn.Open();
                conn.Execute(procedureName, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure);
            }
        }
        ...
        public IEnumerable<T> List<T>(string procedureName, DynamicParameters dynamicParameters = null)
        {
            ...
            {
                conn.Open();
                return conn.Query<T>(procedureName, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure);
            }
        }
        ...
        public Tuple<IEnumerable<T1>, IEnumerable<T2>> List<T1, T2>(string procedureName, DynamicParameters dynamicParameters = null)
        {
            ...
            {
                conn.Open();
                var result = SqlMapper.QueryMultiple(conn, procedureName, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public T OneRecord<T>(string procedureName, DynamicParameters dynamicParameters = null)
        {
            ...
            {
                conn.Open();
                var value = conn.Query<T>(procedureName, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public T Single<T>(string procedureName, DynamicParameters dynamicParameters = null)
        {
            ...
            {
                conn.Open();
                return (T)Convert.ChangeType(conn.ExecuteScalar<T>(procedureName, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure), typeof(T));
            }
        }
    }
}
